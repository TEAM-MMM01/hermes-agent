...
# Command-provider subprocess handling is shared with STT
# (``tools/transcription_tools.py``) — see ``tools/command_provider_process.py``.
_terminate_command_tts_process_tree = terminate_process_tree
_command_provider_env_passthrough = provider_env_passthrough
_run_command_tts = run_command_provider
